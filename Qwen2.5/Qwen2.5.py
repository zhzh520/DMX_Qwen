...
<p align="center"><img src="https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/assets/logo/qwen2.5_logo.png" style="height: 120px"/><p>""")
        gr.Markdown(
            """\
<center><font size=3>This WebUI is based on Qwen2.5-0.5B-Instruct, developed by Alibaba Cloud. \
(本WebUI基于Qwen2.5-0.5B-Instruct打造，实现聊天机器人功能。)</center>"""
        )
        gr.Markdown("""\
<center><font size=4>
...
<a href="https://github.com/QwenLM/Qwen2.5">Github</a></center>""")
        ...
        chatbot = gr.Chatbot(label="Qwen2.5", elem_classes="control-height")
